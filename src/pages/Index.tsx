        ...
        <div className="relative">
          ...
          <section className="mb-12 text-center">
            <h1 className="font-pixel text-4xl mb-4 text-retro-pink">
              Learn with <span className="text-retro-yellow">Retro</span>{" "}
              Flashcards
            </h1>
            <p className="font-retro text-2xl text-white max-w-2xl mx-auto">
              The most rad way to study and memorize everything you need to
              know! Flip through digital flashcards with awesome retro vibes.
            </p>
          ...
          <section className="mb-12">
            {/* <h2 className="font-pixel text-2xl mb-6 text-retro-teal text-center">
              Popular Categories
            </h2> */}
            {/* <CategoryGrid /> */}
          </section>
          ...
          {/* <section className="bg-retro-blue border-4 border-retro-black p-6 mt-12 rounded-md retro-shadow">
            <div className="text-center">
              <h2 className="font-pixel text-2xl mb-4 text-white">
                Create Your Own Flashcards
              </h2>
              <p className="font-retro text-xl text-white mb-6">
                Make your own custom flashcards for any subject. It's totally
                easy and super fun!
              </p>
              <Button className="font-retro text-xl bg-retro-yellow text-retro-black border-4 border-retro-black hover:bg-retro-purple hover:text-white retro-shadow">
                Create Now
              </Button>
            </div>
          </section> */}
